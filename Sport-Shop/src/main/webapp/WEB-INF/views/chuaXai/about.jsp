            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="about-desc">
                            <h2>About Us</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc in lobortis orci, sit amet ornare purus. Duis lobortis pulvinar diam eu iaculis. Quisque pellentesque rhoncus dolor, vitae egestas diam porta sit amet. Fusce quis pulvinar velit. Sed efficitur malesuada mauris id tristique. Sed maximus augue quis nibh suscipit, eu vehicula ante pellentesque. Fusce pretium, nibh eu aliquet sodales, sapien mi egestas urna, et gravida tortor elit a sem. </p>
                            <h2>Our Brand</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc in lobortis orci, sit amet ornare purus. Duis lobortis pulvinar diam eu iaculis. Quisque pellentesque rhoncus dolor, vitae egestas diam porta sit amet. Fusce quis pulvinar velit. Sed efficitur malesuada mauris id tristique. Sed maximus augue quis nibh suscipit, eu vehicula ante pellentesque. Fusce pretium, nibh eu aliquet sodales, sapien mi egestas urna, et gravida tortor elit a sem. Donec ut malesuada nibh. Nunc tincidunt, lacus non dapibus pulvinar, velit ex lacinia enim, ac volutpat metus justo ac nulla. Phasellus condimentum blandit dui a consectetur.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="about-img">
                ...
                <div class="row">
                    <div class="counter-banner">
                        <div class="text-center mg-bt-80">
                            <div class="container">
                                <div class="row">
                                    <div class="counter-block">
                                        <div class="col-md-3 col-sm-3 col-xs-3 width-100">
                                            <div class="counter-details">
                                                <h3 class='counter' data-slno='1' data-min='0' data-max='1200' data-delay='.5' data-increment=4>1200</h3>
                                                <h4>Awards Won!</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-3 width-100">
                                            <div class="counter-details">
                                                <h3 class='counter' data-slno='1' data-min='0' data-max='4000' data-delay='8' data-increment="1">4000</h3>
                                                <h4>There Anyone</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-3 width-100">   
                                            <div class="counter-details">
                                                <h3 class='counter' data-slno='1' data-min='0' data-max='2000' data-delay='.5' data-increment="11">2000</h3>
                                                <h4>Happy Clients</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-3 width-100">   
                                            <div class="counter-details">
                                                <h3 class='counter' data-slno='1' data-min='0' data-max='1000' data-delay='.5' data-increment="11">1000</h3>
                                                <h4>Team Members</h4>
                                            </div>
                                        </div>
                                    </div>
