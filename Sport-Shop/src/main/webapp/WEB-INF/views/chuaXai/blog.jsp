...
<html lang="en">
    ...
    <body id="myPage">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="user-value">
                                <ul>
                                    ...
                                    <li><a href="register.html"> <i class="fa fa-tag" aria-hidden="true"></i> Register</a> </li>
                                                    ...
                                                    <div class="items-inner">
                                                        <div class="row">
                                                            <div class="col-sm-4 col-xs-4 cart-item-image">
                                                                <a href="#">
                                                                    <img src="images/pro1.png" alt="" style="width: 80px;">
                                                                </a>
                                                            </div>
                    ...
                    <div class="container">
                        ...
                        <nav class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-left">                 
                                ...
                                <li class="dropdown"><a class="dropdown-toggle flip-animate" data-toggle="dropdown"><span data-hover="Shop">Shop</span></a>
        ...
        <section class="padding-top100">
            <div class="container">
                <div class="row">
                    <ul class="col-xs-12 blog-block">
                        <li class="blog-box">
                            <div class="blog-title">
                                <h2><a href="blog-single.html">Kids Activities Blog</a></h2>
                            </div>
                            <div class="blog-img">
                                <img src="images/blog-img2.jpg" alt="blog-img" class="img-responsive">
                            </div>
                            <div class="blog-desc">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean scelerisque, libero sed fermentum tincidunt, neque elit ultrices augue, et pellentesque ante arcu at ante. Vivamus ultrices porttitor nisl in faucibus. Mauris molestie elementum diam non feugiat. Morbi ullamcorper eu risus in convallis. Morbi tincidunt varius odio eu maximus. Sed feugiat tempor dui ac tincidunt. Maecenas eu nunc porta massa lobortis dictum. Curabitur cursus ultrices metus at euismod. Fusce ligula nisi, elementum interdum ipsum non, vestibulum suscipit sapien. Aliquam eget efficitur purus, sit amet facilisis velit. Etiam dictum elementum massa. Curabitur at massa sagittis, dignissim arcu et, cursus sem. Mauris sollicitudin cursus libero, et lobortis diam cursus vitae. Curabitur mollis laoreet orci at suscipit.</p>
                                <div class="site-btn">
                        ...
                        <li class="blog-box">
                            ...
                            <div class="blog-img">
                                <img src="images/blog-img6.jpg" alt="blog-img" class="img-responsive">
                            </div>
                            <div class="blog-desc">
                                <ul class="blog-date-time">
                                    <li>
                        ...
                        <li class="blog-box">
                            ...
                            <div class="blog-img">
                                <img src="images/blog-img4.jpg" alt="blog-img" class="img-responsive">
                            </div>
                            <div class="blog-desc">
                                <ul class="blog-date-time">
                                    <li>
                        ...
                        <li class="blog-box">
                            ...
                            <div class="blog-img">
                                <img src="images/blog-img5.jpg" alt="blog-img" class="img-responsive">
                            </div>
                            <div class="blog-desc">
                                <ul class="blog-date-time">
                                    <li>
                        ...
                        <li class="blog-box">
                            ...
                            <div class="blog-img">
                                <img src="images/blog-img1.jpg" alt="blog-img" class="img-responsive">
                            </div>
                            <div class="blog-desc">
                                <ul class="blog-date-time">
                                    <li>
        ...
        <a id="back-to-top" class="scrollTop back-to-top" href="javascript:void(0);" style="display: none;">
            <img src="images/teddy-bear.png" class="tv-bounce img-responsive" alt="back-to-top">
        </a>
    </body>
</html>
