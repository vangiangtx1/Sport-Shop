...
<c:if test="${pagedListHolder.pageCount > 1}">
	<ul class="pagination justify-content-end">
		<c:if test="${!pagedListHolder.firstPage}">
			<li class="page-item"><a class="page-link" onclick="clickButtonPage('pageButton',this);return false;"
		...
		<c:forEach begin="${pagedListHolder.firstLinkedPage}"
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a class="page-link" onclick="clickButtonPage('pageButton',this);return false;"
